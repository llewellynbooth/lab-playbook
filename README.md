...
## Lab Status
**Phase:** Week 3 — Azure Arc onboarding complete
...
|---|---|---|---|---|---|
| HVHOST1 | 192.168.20.10 | WS2025 DC Eval | ? | ? Connected | ? Ready |
| HVHOST2 | 192.168.20.11 | WS2025 DC Eval | ? | ? Connected | ? Ready |

## VM Status
| VM | Host | IP | Role | Arc | Status |
|---|---|---|---|---|---|
| DC1 | HVHOST1 | 192.168.10.10 | AD DS, DNS | ? Connected | ? |
| DC2 | HVHOST2 | 192.168.10.11 | AD DS, DNS | ? Connected | ? |
| JUMPHOST | HVHOST2 | 192.168.10.20 | WAC, RSAT | ? Connected | ? |
| pfSense | HVHOST1 | 192.168.20.20 | Firewall, Router | N/A | ? |
...
|---|---|---|
| Deploy and manage AD DS | 2, 4 | ? Week 2 done |
| Manage AD DS and advanced identities | 4 | ? Planned |
...
- Laptop RDP access to JUMPHOST — pfSense rule port 3389
- WAC accessible from laptop — pfSense rule port 4443
- Domain user accounts — Week 4
- PKI / internal CA — Week 5
- WAC certificate — Week 5
